...
<div class="container py-3">
    <header>
        <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
            ...
            <span class="fs-4">Mis Series</span>

            <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
                <a class="me-3 py-2 link-body-emphasis text-decoration-none" href="#" id="explorar">Explorar</a>
                <a class="me-3 py-2 link-body-emphasis text-decoration-none" href="#" id="misSeries">Mis Series</a>
            </nav>
        </div>
    </header>
