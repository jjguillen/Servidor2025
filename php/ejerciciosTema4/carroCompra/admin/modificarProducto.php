...
?>							
								<form action="../controlador.php" method="POST" id="modificarProductoForm" enctype="multipart/form-data">
									<div class="mb-3 row">
										...
										<div class="col-sm-7">
										<input type="text" class="form-control-plaintext" id="nombre" name="nombre" value="<?= $producto['nombre']; ?>" required>
										</div>
									</div>
									...
									<div class="mb-3 row">
										...
										<div class="col-sm-7">
										<input type="number" class="form-control-plaintext" id="precio" name="precio" min="1"  value="<?= $producto['precio']; ?>" required>
										</div>
									</div>
		...
		<?php
			$categorias = array( 
				array("categoria" => "teclados", "valor" => "Teclados"),
				array("categoria" => "ratones", "valor" => "Ratones"),
				array("categoria" => "monitores", "valor" => "Monitores"),
				array("categoria" => "graficas", "valor" => "Gráficas"),
				array("categoria" => "procesadores", "valor" => "Procesadores")
			);

			foreach($categorias as $categoria) {
				if (strcmp($producto['categoria'],$categoria["categoria"]) == 0) {
					echo '<option selected value="'.$categoria["categoria"].'">'.$categoria["valor"].'</option>';
				} else {
					echo '<option value="'.$categoria["categoria"].'">'.$categoria["valor"].'</option>';
				}
			}
		?>
											</select>
		...
		<?php
			if ($producto["ivaR"] == 1) {
				echo '<input class="form-check-input" type="checkbox" checked name="ivaR" id="ivaR">';
			} else {
				echo '<input class="form-check-input" type="checkbox" name="ivaR" id="ivaR">';
			}
		?>
		...
		?>
					...
					<div class="row">
						<div class="col-5 col-lg-3 col-xxl-2 d-flex">
							<button type="submit" form="modificarProductoForm" name="modificarProducto" class='btn btn-primary'>Modificar</button>
						</div>
					</div>
